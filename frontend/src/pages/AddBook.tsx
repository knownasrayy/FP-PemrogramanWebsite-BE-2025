  ...
  return (
    <div className="min-h-screen bg-bookit-bg">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-bookit-dark mb-2">Tambah Buku Baru</h1>
          <p className="text-bookit-text-medium">Lengkapi informasi buku yang akan ditambahkan</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
              ...
              <div>
                ...
                {genres.length === 0 && (
                  <p className="text-xs text-gray-500 mt-1">
                    {error ? 'Gagal memuat genre' : 'Memuat data genre...'}
                  </p>
                )}
              </div>
            ...
            <div className="border-t border-gray-200 pt-6">
              <div className="flex justify-end space-x-4">
                ...
                >
                  {loading ? 'Menyimpan...' : successMessage ? 'Berhasil!' : 'Tambah Buku'}
                </button>
              </div>
            </div>
          </form>
